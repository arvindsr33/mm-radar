...
What's new:
    v1.0.1: HSI header assert included 
'''
...
class DataHandling: 
    ...
    def micro_doppler_stft(self, dir_name, max_velocity, save_path = '/mnt/c/work/rcube_extract/dca_capture/micro_doppler/'):
        ...
        plt.imshow(micro_doppler_spectrum, aspect=2, extent=[0, micro_doppler_spectrum.shape[1]/self.frames_per_second, -max_velocity, max_velocity], cmap='gnuplot2')

...
class TI:
    ...
    def __init__(self, sdk_version=2.0, cli_loc='COM6', cli_baud=115200,
                 data_loc='COM5', data_baud=921600, num_rx=4, num_tx=1,
        ...
        #if mode == 0:             # // not desired
        #    self._initialize()

    def _configure_radar(self, config, print_outputs=True):
        for i in config:
            #print(i)
            if i[0] != '%':
                ...
                time.sleep(0.1)
                #if print_outputs:
                print(str(self.cli_port.read_until(terminator=b'Done\n')))
        return 
    ...
    def _initialize(self, config_file='./1642config.cfg'):
        ...
        self.config_params["numRangeBins"] = num_adc_samples
        ...
        return self.config_params  # // Added return statement 
